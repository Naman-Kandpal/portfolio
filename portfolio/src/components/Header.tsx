        ...
        <header className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-4 border-b border-slate-700 shadow-lg">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <nav className="flex items-center space-x-8">
                    ...
                    <a href="/assets/resume.pdf" className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold px-4 py-2 rounded-lg transition shadow-lg hover:shadow-xl">
                        Resume
                    </a>
                </nav>
            </div>
